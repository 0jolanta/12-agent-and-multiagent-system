...
def main():
    ...
    parser.add_argument('--przeszkody', default=10, dest='obstacles', type=int)
    parser.add_argument('--kamienie', default=100, dest='rocks', type=int)
    parser.add_argument('--poszukiwacze', default=10, dest='explorers', type=int)
    parser.add_argument('--przewoźnicy', default=10, dest='carriers', type=int)
